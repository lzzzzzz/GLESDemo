...
import com.lz.gles.shape.TShape.FloatColorSquare;

import javax.microedition.khronos.egl.EGLConfig;
import javax.microedition.khronos.opengles.GL10;

/**基本着色练习*/
public class ThirdESActivity extends AppCompatActivity {

    public static Intent getIntent(Activity act){
        return new Intent(act,ThirdESActivity.class);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view.setRenderer(new ThirdESRender());
        setContentView(view);
    }

    class ThirdESRender extends OpenGLRenderer {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            square = new FloatColorSquare(0.5f, 0.5f);
            square.draw(gl);
            gl.glPopMatrix();//出栈
